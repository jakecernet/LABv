...
public class Sortiraj {
  public static void navadnoVstavljanje(int[] t) {
  ...
  public static void navadnoIzbiranje(int[] t) {
    int dolzina = t.length;
  ...
  public static void kmetSort(int[] t) {
  ...
  public static void bubble_1(int[] t) {
  ...
  public static void bubble_2(int[] t) {
